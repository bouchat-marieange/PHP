...
<?php
$age = $_GET['age_selection'];
$sexe = $_GET['genre_selection'];
...
// si $sexe == "homme" on peut aussi dire si $sexe != "femme"
{
  echo ("Désolé, vous ne remplissez pas les critères de sélection");
};
?>
...
if ($sexe == femme)
{
  ...
  // Dans toutes les autres situations si $sexe == homme ou/et si $age n'est pas dans tranche d'âge recherchée entre 21 et 40 ans
  {
    echo ("Désolé, vous ne remplissez pas les critères de sélection");
  };
?>
